...
- 주간 스캔 워크플로: https://github.com/iAmSomething/idol-song-app/actions/workflows/weekly-kpop-scan.yml
...
- GitHub Actions가 매주 월요일 오전 9시 KST 기준으로 스캔 실행
- 결과 JSON/CSV를 갱신하고, 웹 앱 데이터에도 자동 반영
