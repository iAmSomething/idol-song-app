...
const REQUIRED_CONSTRAINTS = [
  ...
  ['entity_metadata_fields', 'entity_metadata_fields_entity_id_field_key_key'],
...
const REQUIRED_INDEXES = [
  ...
  ['entity_metadata_fields', 'idx_entity_metadata_fields_entity_id'],
  ['entity_metadata_fields', 'idx_entity_metadata_fields_status'],
