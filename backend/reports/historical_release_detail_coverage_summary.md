...
- detail payload coverage: 1/1 (100.0%), pre-2024 0/0 (0.0%)
- detail trusted coverage: 1/1 (100.0%), pre-2024 0/0 (0.0%)
- title-track resolved coverage: 0/1 (0.0%), pre-2024 0/0 (0.0%), review queue 1
- canonical MV coverage: 0/1 (0.0%), pre-2024 0/0 (0.0%), mv review 0
...
- worst title-track cohort: 2024+ ep 0.0% / target 82.0%
- worst canonical MV cohort: 2024+ ep 0.0% / target 55.0%
- release-detail null review queue: 1 rows
...
| title_track_resolved | `fail` | 0.0% | 80.0% | 0.0% | 60.0% |
| canonical_mv | `fail` | 0.0% | 65.0% | 0.0% | 35.0% |
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| 2024+ | ep | 0 | 1 | 0.0% | 82.0% | `fail` |

## Canonical MV Worst Cohorts

| year band | release kind | resolved | total | ratio | target | status |
| --- | --- | ---: | ---: | ---: | ---: | --- |
| 2024+ | ep | 0 | 1 | 0.0% | 55.0% | `fail` |
